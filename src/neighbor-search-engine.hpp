...
private:
    ...
    const int  k_n_x         = 512; // Sufficiently large value
    const int  k_n_y         = 512; // Sufficiently large value
    const int  k_n_z         = 512; // Sufficiently large value
    const Vec3 k_grid_center = Vec3(0.0, 0.0, 0.0);
};
